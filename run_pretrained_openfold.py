...
def main(args):
    ...
    for tag, seq in zip(tags, seqs):
        ...
        if args.phenix_pdb_model is not None:
            ...
            which will be used for recyling
            """
            import Bio
            ...
            for res in res_list:
                if res.resname == "GLY":
                    ...
                    atom = res["CB"]
                    coord.append(atom.get_coord())
            recyle_dim = processed_feature_dict["aatype"].shape[-1]                  
            processed_feature_dict["x_prev"] = torch.tensor(np.repeat(np.array(coord)[..., None], recyle_dim, axis=-1))
        ...
        print("Mean plddt: {:.2f}".format(mean_plddt))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--phenix_pdb_model", type=str, default=None,
    ...
    parser.add_argument(
        "--model_name", type=str, default="model_5",
